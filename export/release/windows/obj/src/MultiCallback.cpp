...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_272_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",272,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_296_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",296,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_321_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",321,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_325_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",325,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_326_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",326,0x53ff9bc9)

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_272_new)
HXLINE( 280)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 279)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 277)		this->numRemaining = 0;
HXLINE( 276)		this->length = 0;
HXLINE( 275)		this->logId = null();
HXLINE( 284)		this->callback = callback;
HXLINE( 285)		this->logId = logId;
            	}
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_296_add)
HXLINE( 296)			if (_gthis->unfired->exists(id1->__get(0))) {
HXLINE( 298)				_gthis->unfired->remove(id1->__get(0));
HXLINE( 299)				_gthis->fired->push(id1->__get(0));
HXLINE( 300)				_gthis->numRemaining--;
HXLINE( 302)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 303)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 303)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id1->__get(0)) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),322,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 305)				if ((_gthis->numRemaining == 0)) {
HXLINE( 307)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 308)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 308)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),322,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
HXLINE( 309)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 313)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 313)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id1->__get(0))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),322,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
...
HXDLIN( 289)		::Array< ::String > id1 = ::Array_obj< ::String >::__new(1)->init(0,id);
HXDLIN( 289)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 290)		id1[0] = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id1->__get(0));
HXLINE( 291)		this->length++;
HXLINE( 292)		this->numRemaining++;
HXLINE( 293)		 ::Dynamic func = null();
HXLINE( 294)		func =  ::Dynamic(new _hx_Closure_0(id1,_gthis));
HXLINE( 315)		this->unfired->set(id1->__get(0),func);
HXLINE( 316)		return func;
            	}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_321_log)
HXDLIN( 321)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 322)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),322,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_325_getFired)
HXDLIN( 325)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_326_getUnfired)
HXDLIN( 326)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 326)		{
HXDLIN( 326)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 326)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 326)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 326)				_g->push(id1);
            			}
            		}
HXDLIN( 326)		return _g;
            	}
