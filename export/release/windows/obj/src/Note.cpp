...
HXLINE( 224)				prevNote->scale->set_y((prevNote->scale->y * ((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05))));
HXLINE( 225)				if (::hx::IsNotNull( ::PlayState_obj::instance )) {
HXLINE( 227)					prevNote->scale->set_y((prevNote->scale->y * ::PlayState_obj::instance->songSpeed));
            				}
HXLINE( 230)				if (::PlayState_obj::isPixelStage) {
HXLINE( 231)					prevNote->scale->set_y((prevNote->scale->y * ((Float)1.19)));
HXLINE( 232)					{
HXLINE( 232)						 ::flixel::math::FlxBasePoint this1 = prevNote->scale;
HXDLIN( 232)						Float prevNote1 = prevNote->scale->y;
HXDLIN( 232)						this1->set_y((prevNote1 * (( (Float)(6) ) / this->get_height())));
            					}
            				}
HXLINE( 234)				prevNote->updateHitbox();
            			}
HXLINE( 238)			if (::PlayState_obj::isPixelStage) {
HXLINE( 239)				this->scale->set_y((this->scale->y * ::PlayState_obj::daPixelZoom));
...
HXLINE( 109)			this->scale->set_y((this->scale->y * ratio));
