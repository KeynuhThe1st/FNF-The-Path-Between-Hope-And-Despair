...
HXLINE( 362)		::haxe::Log_obj::trace(HX_("the image didnt load. back to the works :pensive:",d6,ff,13,80),::hx::SourceInfo(HX_("source/Paths.hx",64,c7,bd,1c),362,HX_("Paths",0e,7b,84,50),HX_("returnGraphic",d8,d3,95,0b)));
