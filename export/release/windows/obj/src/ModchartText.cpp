...
HX_DEFINE_STACK_FRAME(_hx_pos_552a6f94cb341f6a_3317_new,"ModchartText","new",0x58e3633b,"ModchartText.new","FunkinLua.hx",3317,0x00117937)

void ModchartText_obj::__construct(Float x,Float y,::String text,Float width){
            	HX_STACKFRAME(&_hx_pos_552a6f94cb341f6a_3317_new)
HXLINE(3319)		this->wasAdded = false;
HXLINE(3322)		super::__construct(x,y,width,text,16,null());
HXLINE(3323)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(3323)		::String _hx_tmp;
HXDLIN(3323)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(3323)			_hx_tmp = file;
            		}
            		else {
HXLINE(3323)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(3323)		this->setFormat(_hx_tmp,16,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(3324)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::PlayState_obj::instance->camHUD));
HXLINE(3325)		{
HXLINE(3325)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
HXDLIN(3325)			this1->set_x(( (Float)(0) ));
HXDLIN(3325)			this1->set_y(( (Float)(0) ));
            		}
HXLINE(3326)		this->set_borderSize(( (Float)(2) ));
            	}
