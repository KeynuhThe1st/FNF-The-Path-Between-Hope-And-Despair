...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_62_init,"Main","init",0xea732345,"Main.init","Main.hx",62,0x087e5c05)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_113_onCrash,"Main","onCrash",0x46bec533,"Main.onCrash","Main.hx",113,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_44_main,"Main","main",0xed0e206e,"Main.main","Main.hx",44,0x087e5c05)

void Main_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_29_new)
HXLINE(  37)		this->startFullscreen = false;
HXLINE(  36)		this->skipSplash = true;
HXLINE(  35)		this->framerate = 60;
HXLINE(  34)		this->zoom = ((Float)-1);
HXLINE(  33)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  32)		this->gameHeight = 720;
HXLINE(  31)		this->gameWidth = 1280;
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_62_init)
HXLINE(  63)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  65)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  68)		::LagPrevention_obj::init();
...
HXLINE(  74)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  75)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  77)		if ((this->zoom == -1)) {
HXLINE(  79)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  80)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  81)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  82)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  83)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  86)		::ClientPrefs_obj::loadDefaultKeys();
HXLINE(  87)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,0,0,::hx::ClassOf< ::TitleState >(),60,60,true,false));
...
HXLINE( 105)		::openfl::Lib_obj::get_current()->get_loaderInfo()->uncaughtErrorEvents->addEventListener(HX_("uncaughtError",f3,98,8b,8b),this->onCrash_dyn(),null(),null(),null());
            	}
...
void Main_obj::onCrash( ::openfl::events::UncaughtErrorEvent e){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_113_onCrash)
HXLINE( 114)		::String errMsg = HX_("",00,00,00,00);
HXLINE( 116)		::Array< ::Dynamic> callStack = ::haxe::_CallStack::CallStack_Impl__obj::exceptionStack(true);
HXLINE( 117)		::String dateNow = ::Date_obj::now()->toString();
HXLINE( 119)		dateNow = ::StringTools_obj::replace(dateNow,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00));
HXLINE( 120)		dateNow = ::StringTools_obj::replace(dateNow,HX_(":",3a,00,00,00),HX_("'",27,00,00,00));
HXLINE( 115)		::String path = (((HX_("./crash/",69,79,f9,62) + HX_("PsychEngine_",82,ba,54,e7)) + dateNow) + HX_(".txt",02,3f,c0,1e));
HXLINE( 124)		{
HXLINE( 124)			int _g = 0;
HXDLIN( 124)			while((_g < callStack->length)){
HXLINE( 124)				 ::haxe::StackItem stackItem = callStack->__get(_g).StaticCast<  ::haxe::StackItem >();
HXDLIN( 124)				_g = (_g + 1);
HXLINE( 126)				if ((stackItem->_hx_getIndex() == 2)) {
HXLINE( 128)					 ::haxe::StackItem s = stackItem->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 128)					::String file = stackItem->_hx_getString(1);
HXDLIN( 128)					int line = stackItem->_hx_getInt(2);
HXDLIN( 128)					 ::Dynamic column = stackItem->_hx_getObject(3);
HXLINE( 129)					errMsg = (errMsg + (((file + HX_(" (line ",a4,24,f7,a5)) + line) + HX_(")\n",c1,23,00,00)));
            				}
            				else {
HXLINE( 131)					::Sys_obj::println(stackItem);
            				}
            			}
            		}
HXLINE( 135)		errMsg = (errMsg + ((HX_("\nUncaught Error: ",ed,bf,e1,72) + ::Std_obj::string(e->error)) + HX_("\nPlease report this error to the GitHub page: https://github.com/ShadowMario/FNF-PsychEngine\n\n> Crash Handler written by: sqirra-rng",3c,20,3f,85)));
HXLINE( 137)		if (!(::sys::FileSystem_obj::exists(HX_("./crash/",69,79,f9,62)))) {
HXLINE( 138)			::sys::FileSystem_obj::createDirectory(HX_("./crash/",69,79,f9,62));
            		}
HXLINE( 140)		::sys::io::File_obj::saveContent(path,(errMsg + HX_("\n",0a,00,00,00)));
HXLINE( 142)		::Sys_obj::println(errMsg);
HXLINE( 143)		::Sys_obj::println((HX_("Crash dump saved in ",cf,9c,69,5d) + ::haxe::io::Path_obj::normalize(path)));
HXLINE( 145)		::lime::app::Application_obj::current->_hx___window->alert(errMsg,HX_("Error!",79,f7,fc,85));
HXLINE( 146)		::DiscordClient_obj::shutdown();
HXLINE( 147)		::Sys_obj::exit(1);
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_44_main)
HXDLIN(  44)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  44)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
