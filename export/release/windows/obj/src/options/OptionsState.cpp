...
static const ::String _hx_array_data_14992103_1[] = {
	HX_("TPBHAD",a5,a7,df,d1),HX_("Note Colors",1e,54,23,f8),HX_("Controls",96,42,6e,11),HX_("Adjust Delay and Combo",b7,c9,c3,05),HX_("Graphics",eb,b4,19,ec),HX_("Visuals and UI",ea,4a,1e,90),HX_("Gameplay",06,bf,58,a5),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_88_closeSubState,"options.OptionsState","closeSubState",0xbc3ad39e,"options.OptionsState.closeSubState","options/OptionsState.hx",88,0xaa608eba)
...
HXLINE(  32)		this->options = ::Array_obj< ::String >::fromData( _hx_array_data_14992103_1,7);
...
HXDLIN(  42)			goto _hx_goto_2;
            		...
            		if (  (_hx_switch_0==HX_("TPBHAD",a5,a7,df,d1)) ){
HXLINE(  40)			this->openSubState( ::options::TPBHADOptionsSubState_obj::__alloc( HX_CTX ));
...
HXDLIN(  64)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuBG",24,65,6d,05),library);
HXDLIN(  64)		this->add(_hx_tmp->loadGraphic(returnAsset,null(),null(),null(),null(),null()));
...
HXLINE(  71)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->options->__get(i),true);
HXLINE(  72)				{
HXLINE(  72)					int axes = 17;
HXDLIN(  72)					bool _hx_tmp;
HXDLIN(  72)					if ((axes != 1)) {
HXLINE(  72)						_hx_tmp = (axes == 17);
            					}
            					else {
...
HXDLIN(  72)						optionText->set_x(((( (Float)(_hx_tmp) ) - optionText->get_width()) / ( (Float)(2) )));
            					}
HXDLIN(  72)					bool _hx_tmp1;
HXDLIN(  72)					if ((axes != 16)) {
HXLINE(  72)						_hx_tmp1 = (axes == 17);
            					}
            					else {
...
HXDLIN(  72)						optionText->set_y(((( (Float)(_hx_tmp) ) - optionText->get_height()) / ( (Float)(2) )));
            					}
            				}
HXLINE(  73)				optionText->set_y((optionText->y + ((( (Float)(100) ) * (( (Float)(i) ) - (( (Float)(this->options->length) ) / ( (Float)(2) )))) + 50)));
HXLINE(  74)				this->grpOptions->add(optionText).StaticCast<  ::Alphabet >();
            			}
            		}
HXLINE(  77)		this->selectorLeft =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_(">",3e,00,00,00),true);
HXLINE(  78)		this->add(this->selectorLeft);
HXLINE(  79)		this->selectorRight =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("<",3c,00,00,00),true);
HXLINE(  80)		this->add(this->selectorRight);
HXLINE(  82)		this->changeSelection(null());
HXLINE(  83)		::ClientPrefs_obj::saveSettings();
HXLINE(  85)		this->super::create();
            	}


void OptionsState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_bddb8806f8971119_88_closeSubState)
HXLINE(  89)		this->super::closeSubState();
HXLINE(  90)		::ClientPrefs_obj::saveSettings();
            	}
...
HXLINE(  96)		if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
HXLINE(  97)			this->changeSelection(-1);
            		}
HXLINE(  99)		if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
...
HXDLIN( 104)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 105)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 108)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
...
HXLINE( 114)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::options::OptionsState >();
HXDLIN( 114)		::options::OptionsState_obj::curSelected = (::options::OptionsState_obj::curSelected + change);
HXLINE( 115)		if ((::options::OptionsState_obj::curSelected < 0)) {
HXLINE( 116)			::options::OptionsState_obj::curSelected = (this->options->length - 1);
            		}
HXLINE( 117)		if ((::options::OptionsState_obj::curSelected >= this->options->length)) {
HXLINE( 118)			::options::OptionsState_obj::curSelected = 0;
            		}
HXLINE( 120)		int bullShit = 0;
HXLINE( 122)		{
HXLINE( 122)			int _g = 0;
HXDLIN( 122)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 122)			while((_g < _g1->length)){
HXLINE( 122)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 122)				_g = (_g + 1);
HXLINE( 123)				item->targetY = (bullShit - ::options::OptionsState_obj::curSelected);
HXLINE( 124)				bullShit = (bullShit + 1);
HXLINE( 126)				item->set_alpha(((Float)0.6));
HXLINE( 127)				if ((item->targetY == 0)) {
HXLINE( 128)					item->set_alpha(( (Float)(1) ));
HXLINE( 129)					this->selectorLeft->set_x((item->x - ( (Float)(63) )));
HXLINE( 130)					this->selectorLeft->set_y(item->y);
HXLINE( 131)					 ::Alphabet _hx_tmp = this->selectorRight;
HXDLIN( 131)					Float item1 = item->x;
HXDLIN( 131)					_hx_tmp->set_x(((item1 + item->get_width()) + 15));
HXLINE( 132)					this->selectorRight->set_y(item->y);
            				}
            			}
            		}
HXLINE( 135)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 135)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            	}
