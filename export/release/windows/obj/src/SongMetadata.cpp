...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_553_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",553,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_553_new)
HXLINE( 559)		this->folder = HX_("",00,00,00,00);
HXLINE( 558)		this->color = -7179779;
HXLINE( 557)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 556)		this->week = 0;
HXLINE( 555)		this->songName = HX_("",00,00,00,00);
HXLINE( 563)		this->songName = song;
HXLINE( 564)		this->week = week;
HXLINE( 565)		this->songCharacter = songCharacter;
HXLINE( 566)		this->color = color;
HXLINE( 567)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 568)		if (::hx::IsNull( this->folder )) {
HXLINE( 568)			this->folder = HX_("",00,00,00,00);
            		}
            	}
